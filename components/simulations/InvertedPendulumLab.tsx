...
function PendulumScene({ state, params, reference }: { state: CartPoleState; params: CartPoleParams; reference: number }) {
  ...
  return <div className="pendulum-stage"><svg viewBox="0 0 1000 480" role="img" aria-label={`倒立摆，摆角 ${angleDegrees.toFixed(2)} 度，小车位置 ${state.x.toFixed(2)} 米，参考位置 ${reference.toFixed(2)} 米`}>
    ...
    <g><line x1={cartX} y1="296" x2={poleEndX} y2={poleEndY} stroke="#05080b" strokeWidth="11" strokeLinecap="round" opacity=".65" vectorEffect="non-scaling-stroke" /><line x1={cartX} y1="296" x2={poleEndX} y2={poleEndY} stroke="url(#metal)" strokeWidth="7" strokeLinecap="round" vectorEffect="non-scaling-stroke" /><line x1={cartX - 1} y1="295" x2={poleEndX - 1} y2={poleEndY - 1} stroke="#d5dde4" strokeWidth="1" strokeLinecap="round" opacity=".45" vectorEffect="non-scaling-stroke" /><circle cx={poleEndX} cy={poleEndY} r="25" fill="#202a34" stroke="#8d9aa7" strokeWidth="5" /><circle cx={poleEndX} cy={poleEndY} r="8" fill="#b7ff4a" /><circle cx={cartX} cy="296" r="13" fill="#0b1015" stroke="#d1dae2" strokeWidth="4" /></g>
  </svg></div>;
}
